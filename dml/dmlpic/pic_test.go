...
import (
    ...
    "github.com/prr123/godocx/dml/dmlct"
    "github.com/prr123/godocx/dml/dmlprops"
    "github.com/prr123/godocx/dml/dmlst"
    "github.com/prr123/godocx/dml/shapes"
)
...
// test with rotation
func TestRotPicMarshalXML(t *testing.T) {
	p := &Pic{
		NonVisualPicProp: NonVisualPicProp{
			CNvPr: dmlct.CNvPr{
				ID:          1,
	...
	// Expected XML output
	expectedXML := `<pic:pic xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture"><pic:nvPicPr><pic:cNvPr id="1" name="Pic 1" descr="Description"></pic:cNvPr><pic:cNvPicPr><a:picLocks noChangeAspect="1" noChangeArrowheads="1"></a:picLocks></pic:cNvPicPr></pic:nvPicPr><pic:blipFill><a:blip r:embed="rId1"></a:blip><a:stretch><a:fillRect></a:fillRect></a:stretch></pic:blipFill><pic:spPr><a:xfrm rot="5400000"><a:off x="0" y="0"></a:off><a:ext cx="100000" cy="100000"></a:ext></a:xfrm><a:prstGeom prst="rect"></a:prstGeom></pic:spPr></pic:pic>`
...
func TestRotPicUnmarshalXML(t *testing.T) {
	xmlData := `<pic:pic xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture">
        	<pic:nvPicPr>
        		<pic:cNvPr id="1" name="Pic 1" descr="Description"></pic:cNvPr>
        		<pic:cNvPicPr>
